...
import { CoffeItem } from "../pages/Home/components/OurCoffees/CardCoffee/CardCoffee";
...
interface CartContextData {
  ...
  changeCartItemQuantity: (product: CartItem, type: 'increment' | 'decrement') => void
  cleanCart: () => void
}
...
export function CartProvider({ children }: CartProviderProps) {
  ...
  return (
    <CartContext.Provider
      value={{ cart, addProduct, removeProductCart, cartItemsTotal, changeCartItemQuantity, cleanCart }}
    >
      {children}
    </CartContext.Provider>
  )
